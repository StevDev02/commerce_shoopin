...
export function HeroText () {
  return (
    <>
      <h4 className='text-[25px] font-bold '>¡Bienvenidos!</h4>
      <h2 className='text-[35px] -mt-1 font-extrabold'>Tienda de online</h2>
      <h1 className='text-[55px] -mt-2 font-black '> SABATA</h1>
